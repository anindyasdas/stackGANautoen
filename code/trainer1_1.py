...
from model1 import comrec1, G_NET, D_NET64, D_NET128, D_NET256, D_NET512, D_NET1024, INCEPTION_V3


device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
finetuned = 'comrec1_gan_model64_256.pt'
# ################## Shared functions ###################
...
def load_network(gpus, path):
    ...
    if cfg.TRAIN.NET_G != '':
        ...
        #Epath = os.path.join(path, 'encG_%d.pth' %count )
...
class condGANTrainer(object):
    ...
    def train_Gnet(self, count):
        ...
        return kl_loss, errG_total- errM_total, errM_total
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            for step, data in enumerate(self.data_loader, 0):
                ...
                self.txt_embedding = self.enc.enco.encode(self.ureal_imgs[0])
