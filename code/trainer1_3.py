...
from model1 import  G_NET, D_NET64, D_NET128, D_NET256, D_NET512, D_NET1024, INCEPTION_V3
...
class condGANTrainer(object):
    ...
    def train_Gnet(self, count):
        ...
        emb_MSE_loss = criterion1(self.txt_embedding_cyl, self.txt_embedd.detach()) * 50 
        err = errG_total + kl_loss +  emb_MSE_loss #+ errM_total #
        ...
        return kl_loss, errG_total, emb_MSE_loss #errG_total#
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            for step, data in enumerate(self.data_loader, 0):
                ...
                self.txt_embedding_cyl= self.enc(self.fake_imgs[0])
                self.txt_embedd= self.enc(self.real_imgs[0])
